...
export const MyAdCard = ({ ad }) => {
    ...
    return (
        <div style={{ marginTop: '100px', display: "flex", flexDirection: 'column' }}>
            ...
            <input value={adData.color}
                placeholder="color"
                id="color"
                type="text"
                name="color"
                onChange={changeHandler} />
            <input value={adData.information}
                placeholder="information"
                id="information"
                type="text"
                name="information"
                onChange={changeHandler} />
            <input value={adData.breed}
                placeholder="breed"
                id="breed"
                type="text"
                name="breed"
                onChange={changeHandler} />
            <input value={adData.animalName}
                placeholder="animalName"
                id="animalName"
                type="text"
                name="animalName"
                onChange={changeHandler} />
            <input value={adData.location}
                placeholder="location"
                id="location"
                type="text"
                name="location"
                onChange={changeHandler} />
            <input value={adData.age}
                placeholder="age"
                id="age"
                type="number"
                name="age"
                onChange={changeHandler} />
            <input value={adData.price}
                placeholder="price"
                id="price"
                type="number"
                name="price"
                onChange={changeHandler} />
            <div>{(adData.picture).map((img) => {
                return (<div><img width={'200px'} height={'200px'} src={img} />
                    <button onClick={() => {
