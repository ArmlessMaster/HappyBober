            ...
            <div className="AdCard">
              <div className="images">
                ...
                <div className="buttons">
                  <p style={{cursor: 'pointer'}} onClick={handleFavourite}><svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <button onClick={() => setModalActive(true)}>Report</button>
                </div>
              </div>
